...
function ReadLayersDisplay () {
  ...
  console.log("Befor first call");
  console.log(communityAssetpath);
  d3.json(communityAssetpath).then(function(data){});
    ...
    var assetArray = [servicesAsset, educationAsset, 
          ...
          d3.json(rentalPath, function(rental){
              ...
              var crimePath = "https://sogramemon.github.io/plotly-javascript-challenge/data/mincrimeLastSixMonths.json";
